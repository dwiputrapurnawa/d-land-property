<section id="section_about_bali" class="flex flex-col pb-16 text-white h-screen mb-28">
    <div class="flex relative flex-col items-start px-5 sm:px-10 md:px-20 pt-24 sm:pt-36 md:pt-56 w-full min-h-[500px] md:min-h-[761px] bg-[url(images/bali.png)] w-full h-screen bg-cover bg-right">
        <!-- Background Image -->
        {{-- <img loading="lazy" src="{{ asset('images/bali.png') }}" alt="Scenic view of Bali" class="object-cover object-right absolute inset-0 w-full h-full md:h-[95%]"> --}}
  ...
  {{-- DESKTOP FOOTER --}}
<div class="hidden sm:flex relative z-10 flex-col sm:flex-row items-center sm:items-start gap-5 mt-10 sm:mt-16 md:mt-36 mb-0 w-full text-center sm:text-left">
