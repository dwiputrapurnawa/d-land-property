<section class="flex flex-col pb-16 text-white">
    <div class="flex relative flex-col items-start px-5 sm:px-10 md:px-20 pt-24 sm:pt-36 md:pt-56 w-full min-h-[500px] md:min-h-[761px] max-w-full">
        ...
        <p class="relative mt-6 sm:mt-8 md:mt-12 text-lg sm:text-2xl md:text-4xl leading-8 sm:leading-9 md:leading-10 w-full md:w-[618px] max-w-full text-center animated-element opacity-0 transition duration-300 ease-in-out">
            <span>Its spectacular mountain scenery</span>
            <span>and</span>
            <span class="italic font-medium">tropical beaches</span>
            <span>make it one of the most popular tourist destinations</span>
            <span class="italic font-medium">in the world.</span>
        </p>
        ...
        <div class="flex relative z-10 flex-col sm:flex-row items-center sm:items-start gap-5 mt-10 sm:mt-16 md:mt-36 mb-0 w-full text-center sm:text-left">
            ...
            <!-- Call-to-Action Box -->
            <div class="flex flex-col px-5 sm:px-9 pt-8 sm:pt-12 md:pt-16 pb-16 sm:pb-20 md:pb-32 text-sm sm:text-base text-center backdrop-blur-lg bg-opacity-50 font-[405] animated-element opacity-0 transition duration-300 ease-in-out ml-auto">
                <a href="#" class="flex items-center gap-2.5">
                    <span class="underline-animation">Read More</span>
