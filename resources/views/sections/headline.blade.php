<section id="section_headline" class="flex flex-col">
    <header class="relative h-screen">
     ...
     @include('partials.navbar_white')    
         ...
         <h1 class="text-white animated-element opacity-0 transition duration-300 ease-in-out relative self-center mt-40 text-7xl text-center leading-[90px] max-md:mt-40 max-md:max-w-full max-md:text-4xl max-md:leading-10">
             <span class="font-[405] tracking-tight">{{ __('landing.headline_1') }}</span>
             <span class="italic font-medium font-century">{{ __('landing.headline_2') }}</span>
             <br />
