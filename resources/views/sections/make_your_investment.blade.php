  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-4 py-32">
    ...
    <div class="grid grid-cols-2 gap-4 col-span-2 p-2">
      <article class="mb-8 animated-element opacity-0 transition duration-300 ease-in-out">
        <h3 class="text-lg md:text-2xl font-normal tracking-wide text-zinc-800 mb-6">Services 01</h3>
      ...
      <article class="mb-8 animated-element opacity-0 transition duration-300 ease-in-out">
        <h3 class="text-lg md:text-2xl font-normal tracking-wide text-zinc-800 mb-6">Services 02</h3>
        <p class="text-sm md:text-xl tracking-wide leading-relaxed text-zinc-700">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit.
        </p>
      </article>
      <article class="mb-8 animated-element opacity-0 transition duration-300 ease-in-out">
        <h3 class="text-lg md:text-2xl font-normal tracking-wide text-zinc-800 mb-6">Services 03</h3>
        <p class="text-sm md:text-xl tracking-wide leading-relaxed text-zinc-700">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit.
        </p>
      </article>
      <article class="mb-8 animated-element opacity-0 transition duration-300 ease-in-out">
        <h3 class="text-lg md:text-2xl font-normal tracking-wide text-zinc-800 mb-6">Services 04</h3>
        <p class="text-sm md:text-xl tracking-wide leading-relaxed text-zinc-700">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit.
        </p>
      </article>
