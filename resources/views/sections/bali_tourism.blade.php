<section class="w-full h-full mb-12 lg:mb-28 justify-items-center">
  ...
  <img src="{{ asset('images/bali-tourism-cover.webp') }}" class="object-center object-cover h-full w-full" alt="">


    <div class="grid grid-cols-1 md:grid-cols-2 container py-20 px-8">

      <div class="lg:w-3/5 flex flex-col mb-10">
        <p class="text-sm text-gray-400 uppercase tracking-wider mb-4 animated-element opacity-0 transition duration-300 ease-in-out uppercase">{{ __('landing.analytics_section_text') }}</p>
        <h1 class="text-4xl lg:text-5xl font-light text-gray-900 animated-element opacity-0 transition duration-300 ease-in-out">
          {{ __('landing.analytics_header_text_1') }} <br><span class="italic font-semibold font-century">{{ __('landing.analytics_header_text_2') }}</span>
        </h1>
      </div>

      <div class="lg:w-5/6 pt-8">
        <h2 class="mb-10 text-lg md:text-2xl animated-element opacity-0 transition duration-300 ease-in-out">
          {{ __('landing.analytics_content_1') }}
        </h2>

        <h2 class="mb-4 text-lg md:text-2xl animated-element opacity-0 transition duration-300 ease-in-out">
          {{ __('landing.analytics_content_2') }}
        </h2>
      </div>
