...
@endif
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('admin.project.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full flex items-center">
    ...
    <table id="table-project" class="table-auto flex-col" data-url="{{ route("get.project") }}">
      <thead>
        <tr>
            <th>No</th>
            <th>Project Name</th>
