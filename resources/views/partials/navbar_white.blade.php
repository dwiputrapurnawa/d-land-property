  ...
  <nav class="bg-transparent py-6 text-white relative hover:backdrop-filter hover:backdrop-blur-lg hover:bg-opacity-30 transition duration-700 ease-in-out">
    <div class="px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-16 space-x-3">
        ...
        <div class="flex items-center">
          <a href="/">
            <img id="logo-company" src="{{ asset('images/logo.png') }}" alt="Logo" class="h-12 ml-5 md:h-16 w-auto"> <!-- Replace with your image URL and size -->
          </a>
        </div>
    ...
    <div id="mobileMenu" class="hidden md:hidden flex-col h-screen z-50">
      ...
      <ul class="px-5 space-y-2 z-50">
        <li><a href="{{ route('home.page') }}" class=" text-3xl font-light underline-animation">Home</a></li>
