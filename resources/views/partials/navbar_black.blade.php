  <!-- Navbar -->
  <nav id="nav-text-black" class="bg-transparent py-6 text-black relative hover:backdrop-filter hover:backdrop-blur-lg hover:bg-opacity-30 transition duration-700 ease-in-out">
