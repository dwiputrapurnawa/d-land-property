  <!-- Navbar -->
  <nav id="nav-text-black" class="bg-transparent py-6 z-50 text-black relative hover:backdrop-filter hover:backdrop-blur-lg hover:bg-opacity-30 transition duration-700 ease-in-out">
    <div class="px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between h-16 space-x-3">
        ...
        <div class="flex items-center">
          <a href="/">
            <img id="logo-company" src="{{ asset('images/logo-substract.webp') }}" alt="Logo" class="h-12 ml-5 md:h-16 w-auto lazy"> <!-- Replace with your image URL and size -->
          </a>
        </div>

        <!-- Desktop Menu -->
        <div class="hidden md:flex items-center space-x-16 max-md:space-x-8">
          <a href="{{ route('projects.page') }}" class=" text-sm font-light underline-animation-black">{{ __('landing.navbar_project') }}</a>
          <a href="{{ route('about.us.page') }}" class=" text-sm font-light underline-animation-black">{{ __('landing.navbar_about_us') }}</a>
          <a href="{{ route('management.page') }}" class=" text-sm font-light underline-animation-black">{{ __('landing.navbar_managements') }}</a>
          <a href="{{ route('about.bali.page') }}" class=" text-sm font-light underline-animation-black">{{ __('landing.navbar_about_bali') }}</a>
          <a href="{{ route('news.page') }}" class=" text-sm font-light underline-animation-black">{{ __('landing.navbar_news') }}</a>
         ...
         <div class="relative">
          ...
          <button class="openRequestCallModalBtn  text-sm font-light underline-animation-black flex items-center">
    ...
    <div id="mobileMenu" class="hidden md:hidden flex-col h-screen z-50">
      ...
      <ul class="px-5 space-y-2 z-50">
        ...
        <li><a href="{{ route('about.bali.page') }}" class="text-3xl font-light underline-animation-black">{{ __('landing.navbar_about_bali') }}</a></li>
        <li><a href="{{ route('news.page') }}" class=" text-3xl font-light underline-animation-black">{{ __('landing.navbar_news') }}</a></li>
        <li>


        </li>
        <li>
          <button id="open-request-call-mobile" class="text-3xl font-light underline-animation-black flex items-center">
            {{ __('landing.navbar_request_call') }}
          </button>
        </li>
      </ul>
